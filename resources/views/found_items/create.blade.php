...
@section('content')
    <div class="flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
        <div class="bg-white shadow-2xl rounded-2xl p-10 w-full max-w-lg border border-gray-200">
            <h1 class="text-3xl font-extrabold text-gray-800 mb-6 text-center">Report Found Item</h1>
            ...
            <form method="POST" action="{{ route('found-items.store') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" required 
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring focus:ring-blue-400 bg-gray-50 shadow-sm"></textarea>
                </div>
                ...
                <!-- Submit Button -->
                <button type="submit" 
                class="w-full bg-blue-400 text-white py-3 px-4 rounded-lg hover:bg-blue-500 transition shadow-lg font-semibold">
                    Report Found Item
                </button>
            </form>
        </div>
